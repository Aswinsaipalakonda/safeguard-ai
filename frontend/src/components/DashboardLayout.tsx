...
import { Camera, AlertTriangle, FileText, Settings, ShieldAlert, Menu, X, Bell } from "lucide-react";
...
export default function DashboardLayout() {
  ...
  const navItems = [
    { label: "Dashboard", path: "/monitoring", icon: <Camera size={20} /> },
    { label: "Violations", path: "/violations", icon: <AlertTriangle size={20} /> },
